...
<html class="no-js" >
	<head>
		...
		<meta name="description" content="">
		<meta name="author" content="BresWebDesigner.com">
...
<![endif]-->
		...
		<div class="jumbotron">
			<div class="container">
				...
				<div class="frm_pesquisa col-md-8 col-md-push-2">
					<span class="tit_pesquisa">Pesquise qualquer Empresa por Nome, NIF, morada, telefone, etc.</span>
					<!--Google Searchbar-->
					<script>
						(function() {
		...
		<script>
			...
			(function() {
				$.getJSON( 'novasempresas.json', {
					format: "json"
				})
					.done(function( data ) {
					var empresas = generateRandom(0, data.length-1);
					for(var i=0; i<empresas.length;i++){
						...
						$('.repeater').append('<div class="lista_home" itemscope itemtype="http://schema.org/Organization">'+
											  ...
											  '<p itemprop="address" itemscope itemtype="http://schema.org/PostalAddress"><strong>Morada:</strong><br> <span itemprop="streetAddress">'+data[empresas[i]].morada+' </span><br><span itemprop="postalCode"> '+data[empresas[i]].codPostal+'</span></p>'+	
											  '</div><div class="col-sm-4 col-sm-pull-4">'+
											  '<table class="tbl_dados"><tr>'+
											  '<td><strong>Tel:</strong></td><td itemprop="telephone">'+data[empresas[i]].Tel+'</td></tr><tr>'+
											  '<td><strong>Fax:</strong></td><td itemprop="faxNumber">'+data[empresas[i]].Fax+'</td></tr><tr>'+
											  '<td><strong>GSM:</strong></td><td itemprop="telephone">'+data[empresas[i]].GSM+'</td></tr><tr>'+
											  '<td><strong>Email:</strong></td><td><a href="mailto:'+data[empresas[i]].Email+'" itemprop="email">'+data[empresas[i]].Email+'</a></td></tr><tr>'+
											  '<td><strong>Web:</strong></td><td><a href="http://'+data[empresas[i]].Web+'" itemprop="url">'+data[empresas[i]].Web+'</a></td>'+
											  '</tr></table></div></div></div>'+
											  '<hr>');
						//a cada 10 registos coloca um módulo de publicidade
						if(resto === 0 && i>1){
							$('.repeater').append('<div class="g_ads inline_links">'+
												  '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>'+
												  '<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-0126643354725634"'+
												  'data-ad-slot="5703974521" data-ad-format="auto"></ins><script>'+
